...
1. The website presents six supported commodity profiles and editable numeric/select inputs.
...
- Missing fields, bad types/ranges, unknown categories, unsupported commodities, impossible moisture+fat sums and storage/temperature mismatches return HTTP 422 JSON.
