...
export function foodArt(kind, size = 64) {
  const art = {
    ...
    banana: '<path d="M13 40c12 8 30 7 40-1 2-2 3-5 2-8-7 9-23 11-37 5-4-2-7-5-10-9-2 5 0 10 5 13Z" fill="#efc84d" stroke="#c99b2b" stroke-width="2"/><path d="M19 44c11 4 25 3 33-2" stroke="#fff0a6" stroke-width="3" stroke-linecap="round"/><path d="M10 26c5 0 8 3 10 8m35-5c1-4 0-7-3-9" stroke="#748450" stroke-width="4" stroke-linecap="round"/><path d="m9 23 4-3m40-2 4 2" stroke="#785d36" stroke-width="3" stroke-linecap="round"/>',
